...
<body>
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">TASTY\'S</h1>' .
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">TASTY</h1>
            ...
            <div class="column">
                <div id="Search Table">
                    ...
                    <form id="reservation-form" method="GET" action="availability.php"><br>
                        ...
                        <button type="submit" style="background-color: grey; color: rgb(250, 250, 250); " class="btn" name="submit" >Search</button>
                    </form>
                </div>
            </div>
